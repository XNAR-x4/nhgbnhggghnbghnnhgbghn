...
//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
	if (command === `play`) {
		...
		if (!permissions.has('EMBED_LINKS')) {
			return msg.channel.send("**يجب توآفر برمشن `EMBED LINKS`لدي **")
		}
...
if (message.content.startsWith(adminprefix + 'setActivity')) {//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
  client.user.setActivity(argresult);
    message.channel.send(`**${argresult} تم تغيير بلاينق البوت إلى **`)
} else 
...
if (message.content.startsWith(adminprefix + 'setT')) {
  client.user.setActivity(argresult, "https://www.twitch.tv/idk");
    message.channel.send(`**تم تغيير تويتش البوت إلى  ${argresult}**`)
}
